...
public class EarthquakeCityMap extends PApplet {
	...
	private void printQuakes() 
	{
		...
		for(Marker country: countryMarkers){
			int count = 0;
		    Object name = country.getProperty("name");
		    if(name != null)
		    {
		    	for (Marker quakeMarker : quakeMarkers)
		    	{
		    		Object countryname = quakeMarker.getProperty("country");
		    		if(countryname != null)
		    		{
		    			if(name.toString() == countryname.toString())
		    			{
		    				count += 1;
		    			}
		    		}
		    	...
		    	if(count > 0)
		    	{
		    		System.out.println("Country: " + name + " , Number of EarthQuakes: " + count);
		    	}
		    }
		    else
		    {
